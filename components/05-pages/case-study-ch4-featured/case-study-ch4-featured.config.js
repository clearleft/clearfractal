...
module.exports = {
    ...
    "context": {
        ...
        "textBlockProse": `
            ...
            <p>The agile manifesto was born out of a frustration with traditionally managed projects. But I don’t think it solved the problem. It actually created another one. I’ve seen teams and
            organisations go from waterfall, which reduces their ability to compete in the market and deliver value, to dysfunction and paralysis when implementing agile.</p>
        ...
        "trioModifiers": ["--stacked", "--inverted", "--channel4", "--chimney"],
